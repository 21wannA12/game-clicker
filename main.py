...
key_start = Actor('button', (600, 350))
key_setting = Actor('button', (600, 440))
key_exit = Actor('button', (600, 530))
key_exit_menu = Actor('button', (600, 400))
...
def draw():
    ...
    if mode == 'menu':
        ...
        key_setting.draw()
        key_exit.draw()
        screen.draw.text('The Clicker', center = (600, 280), color= 'black', fontsize=65)
        screen.draw.text('Играть', center = (600, 350), color= 'black', fontsize=30)
        screen.draw.text('Настройки', center = (600, 440), color= 'black', fontsize=30)
        screen.draw.text('Выход', center = (600, 530), color= 'black', fontsize=30)
    #Если режим игры "настройки"
    elif mode == 'setting':
        fon.draw()
        screen.draw.text('Здесь пока нет настроек \n но в будущем они обязательно добавятся!', center = (600, 280), color= 'black', fontsize=65)
        key_exit_menu.draw()
        screen.draw.text('Выход', center = (600, 400), color= 'black', fontsize=30)
